...
class Hasher:
    ...
    def __init__(self, strenght):
        ...
        if self.strenght>100:
            raise FCaDError('Strenght must be<100')
        self._hashdict={}
    ...
    def codefile(self, file_to_code):
        ...
        self.coded=encode(self.file.read(),self._hashdict)
        self.file=open(os.path.splitext(self.file_to_code)[0],'w')
        ...
        if self.do:
            ...
            while True:
                ...
                try:
                    ...
                    raise FCaDError('Key does not exist. Are you sure the file is not decoded?')
